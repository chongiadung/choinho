...
name = 'beemartvn.bizwebvietnam.com'
allowed_domains = ['beemartvn.bizwebvietnam.com']
start_urls = ['http://beemartvn.bizwebvietnam.com/']
tracking_url = ''
sitemap_urls = ['']
...
rules = [
    ...
    Rule(LinkExtractor(allow=['/.+-b\d+\.html($|\?pn=\d+$)']), 'parse'),
